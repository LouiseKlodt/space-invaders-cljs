...
var vec__1791 = axis;
var a_x = cljs.core.nth.call(null,vec__1791,(0),null);
var a_y = cljs.core.nth.call(null,vec__1791,(1),null);
var a_z = cljs.core.nth.call(null,vec__1791,(2),null);
var vec__1794 = v;
var x = cljs.core.nth.call(null,vec__1794,(0),null);
var y = cljs.core.nth.call(null,vec__1794,(1),null);
var z = cljs.core.nth.call(null,vec__1794,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__1797,p__1798){
var vec__1799 = p__1797;
var u1 = cljs.core.nth.call(null,vec__1799,(0),null);
var u2 = cljs.core.nth.call(null,vec__1799,(1),null);
var u3 = cljs.core.nth.call(null,vec__1799,(2),null);
var vec__1802 = p__1798;
var v1 = cljs.core.nth.call(null,vec__1802,(0),null);
var v2 = cljs.core.nth.call(null,vec__1802,(1),null);
var v3 = cljs.core.nth.call(null,vec__1802,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__1805_SHARP_){
return (p1__1805_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__1806_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__1807_SHARP_,angle_lr),angle_ud);
...
var map__1809 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__1809__$1 = (((((!((map__1809 == null))))?(((((map__1809.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1809.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1809):map__1809);
var up = cljs.core.get.call(null,map__1809__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__1809__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5733__auto__ = (function (){var pred__1811 = cljs.core._EQ_;
var expr__1812 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__1811.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__1812))){
return straight;
} else {
if(cljs.core.truth_(pred__1811.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__1812))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__1811.call(null,quil.middlewares.navigation_3d.space,expr__1812))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__1811.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__1812))){
return up;
} else {
if(cljs.core.truth_(pred__1811.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__1812))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__1811.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__1812))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5733__auto__,map__1809,map__1809__$1,up,straight){
return (function (p1__1808_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__1808_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5733__auto__,map__1809,map__1809__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__1814_SHARP_);
});})(initial_state))
);
});
/**
...
var map__1815_1826 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__1815_1827__$1 = (((((!((map__1815_1826 == null))))?(((((map__1815_1826.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1815_1826.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1815_1826):map__1815_1826);
var vec__1816_1828 = cljs.core.get.call(null,map__1815_1827__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_1829 = cljs.core.nth.call(null,vec__1816_1828,(0),null);
var c_y_1830 = cljs.core.nth.call(null,vec__1816_1828,(1),null);
var c_z_1831 = cljs.core.nth.call(null,vec__1816_1828,(2),null);
var vec__1819_1832 = cljs.core.get.call(null,map__1815_1827__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_1833 = cljs.core.nth.call(null,vec__1819_1832,(0),null);
var u_y_1834 = cljs.core.nth.call(null,vec__1819_1832,(1),null);
var u_z_1835 = cljs.core.nth.call(null,vec__1819_1832,(2),null);
var vec__1822_1836 = cljs.core.get.call(null,map__1815_1827__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_1837 = cljs.core.nth.call(null,vec__1822_1836,(0),null);
var p_y_1838 = cljs.core.nth.call(null,vec__1822_1836,(1),null);
var p_z_1839 = cljs.core.nth.call(null,vec__1822_1836,(2),null);
quil.core.camera.call(null,p_x_1837,p_y_1838,p_z_1839,(p_x_1837 + c_x_1829),(p_y_1838 + c_y_1830),(p_z_1839 + c_z_1831),u_x_1833,u_y_1834,u_z_1835);
