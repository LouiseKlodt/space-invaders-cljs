...
return (new CustomEvent(event_name,(function (){var obj25896 = ({"detail":data});
return obj25896;
})()));
} else {
...
var f = (function (){var pred__25903 = cljs.core._EQ_;
var expr__25904 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__25903.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__25904))){
return ((function (pred__25903,expr__25904){
return (function (p1__25897_SHARP_){
return console.warn(p1__25897_SHARP_);
});
;})(pred__25903,expr__25904))
} else {
if(cljs.core.truth_(pred__25903.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__25904))){
return ((function (pred__25903,expr__25904){
return (function (p1__25898_SHARP_){
return console.debug(p1__25898_SHARP_);
});
;})(pred__25903,expr__25904))
} else {
if(cljs.core.truth_(pred__25903.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__25904))){
return ((function (pred__25903,expr__25904){
return (function (p1__25899_SHARP_){
return console.error(p1__25899_SHARP_);
});
;})(pred__25903,expr__25904))
} else {
return ((function (pred__25903,expr__25904){
return (function (p1__25900_SHARP_){
return console.log(p1__25900_SHARP_);
});
;})(pred__25903,expr__25904))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__25907){
...
var eval_fn = cljs.core.get.call(null,map__25908__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__25910_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__25912,(0),null);
var v = cljs.core.nth.call(null,vec__25912,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1594380798448
